...
class AllCNNECG(nn.Module):
    def __init__(self, name: str = "model"):
        super(AllCNNECG, self).__init__()
        self.name = name
        self.checkpoints_files = []
        self.cnn1 = nn.Conv1d(1, 16, kernel_size=3, stride=1, padding=1, padding_mode='circular')
        self.cnn2 = nn.Conv1d(16, 64, kernel_size=3, stride=1, padding=1, padding_mode='circular')
        self.cnn3 = nn.Conv1d(64, 128, kernel_size=3, stride=1, padding=1, padding_mode='circular')
        self.cnn4 = nn.Conv1d(128, 128, kernel_size=1, stride=1, padding=1, padding_mode='circular')
        self.cnn5 = nn.Conv1d(128, 2, kernel_size=1, stride=1, padding=1, padding_mode='circular')
        self.maxpool1 = nn.MaxPool1d(2)
        self.maxpool2 = nn.MaxPool1d(2)
        self.maxpool3 = nn.MaxPool1d(2)
        self.cnnpool1 = nn.Conv1d(16, 16, kernel_size=3, stride=3, padding=1, padding_mode='circular')
        self.cnnpool2 = nn.Conv1d(64, 64, kernel_size=3, stride=3, padding=1, padding_mode='circular')
        self.cnnpool3 = nn.Conv1d(128, 128, kernel_size=3, stride=3, padding=1, padding_mode='circular')
        #self.global_avg = nn.MaxPool1d()
        self.criterion = nn.CrossEntropyLoss()
